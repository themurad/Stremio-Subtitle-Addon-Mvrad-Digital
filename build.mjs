...
async function main() {
  ...
  for (const relativePath of files) {
    ...
    // Leading UTF-8 BOM. The WebVTT spec allows it, and it removes every doubt
    // about the encoding for players that sniff the bytes instead of trusting
    // the Content-Type header — which is what Android was getting wrong.
